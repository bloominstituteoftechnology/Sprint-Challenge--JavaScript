...
The forEach method will execute a function once for each array element.
Map will create a new array of the item looped through and return it

What is the difference between a function and a method?
A function performs a specific task. A Method is an action that can be performed on an object.
...
To access and call functions on an objects parent
