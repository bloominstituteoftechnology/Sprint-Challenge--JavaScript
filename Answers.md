1. .forEach acts on the array that is called, whereas .map creates a new array with the results of the function instead of altering the array which is called.
