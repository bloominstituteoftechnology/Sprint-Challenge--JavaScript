...
// const x = map([1, 2, 3, 4, 5], (val) => { return val * val; });
// console.log(x);
...
// const n = limitFunctionCallCount(() => { return 'hello world'; }, 5);
// console.log(n());
// console.log(n());
// console.log(n());
// console.log(n());
...
const checkMatchingLeaves = (obj) => {
  // return true if every pr(obj)rty on `obj` is the same
