...
<!-- A method is a function that is a property of an object. So a method executes the function specifically for that object. -->

3. What is closure?

<!-- Closure is the closing off of one scope to further code. -->
