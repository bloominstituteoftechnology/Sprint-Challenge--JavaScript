...
* [x] 1. Describe the biggest difference between `.forEach` & `.map`.
* [x] 2. What is the difference between a function and a method?
* [x] 3. What is closure?
* [x] 4. Describe the four rules of the 'this' keyword.
* [x] 5. Why do we need super() in an extended class?
