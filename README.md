...
3. What is closure?
Closure gives access to an outer function scope from an inner function. It’s a combination of function bundled together with reference to its nearby lexical environment.
