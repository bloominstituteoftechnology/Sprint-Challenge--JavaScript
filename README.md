...
1. Describe the biggest difference between `.forEach` & `.map`.
   a. `.forEach` calls a function on each element in an array.
   b. `.map` also calls a function on each element but also can return a new array.
2. What is the difference between a function and a method?
   Function: code block that is called by name and has parameters, can return data.
   Method: code block that is called by a name and is connected to an object.
3. What is closure?
