...
*/
function Volume (volProp){
  CuboidMaker.call(this, volProp);
}
Volume.prototype = Object.create(CuboidMaker.prototype)
Volume.prototype.volume = function(){
...
*/
function SurfaceArea (surfaceProp){
  Volume.call(this, surfaceProp);
}
