...
//Test
console.log(CubiodMaker.prototype.volume(3,5,8))
...
console.log(CubiodMaker.prototype.surfaceArea(3,5,8))
...
*/
const cuboid = new CubiodMaker({length: 4, width: 5, height: 5});
