...
*/
  ...
  function greeting(argument1,argument2){
    return `Hello ${argument1} ${argument2}, nice to meet you!`
  }
...
//simply because of lexical scope, it means that nested function scope
// contains the same scope as the parent thus allowing it to access it. 
