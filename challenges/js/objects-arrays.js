...
console.log(`${tyrantosaurus.weight}kg`);

// What was the diet of a velociraptor?
console.log(`${velcroraptor.diet}`);

// How long was a stegosaurus?
console.log(`${studosaurus.length}m`);

// What time period did tyrannosaurus live in?
console.log(`${tyrantosaurus.period}`);

// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
tyrantosaurus.roar = function() {
  return `RAWERSRARARWERSARARARRRR!`;
}
console.log(tyrantosaurus.roar());
...
const universities = [];
for(let whyforloopswhenicandothiswithforeachquestionmark = 0; whyforloopswhenicandothiswithforeachquestionmark < graduates.length; whyforloopswhenicandothiswithforeachquestionmark++) {
  universities.push(graduates[whyforloopswhenicandothiswithforeachquestionmark].university);
}
...
const contactInfo = [];
for(let shouldhavebeenaforeach = 0; shouldhavebeenaforeach < graduates.length; shouldhavebeenaforeach++) {
  // contactInfo.push({first_name: graduates[shouldhavebeenaforeach].first_name, email: graduates[shouldhavebeenaforeach].email}); <-- oops
  contactInfo.push(`${graduates[shouldhavebeenaforeach].first_name} ${graduates[shouldhavebeenaforeach].email}`);
}
...
const uni = [];
for(let filterfilterfilterfilterfilterfilterfilter=0; filterfilterfilterfilterfilterfilterfilter<graduates.length; filterfilterfilterfilterfilterfilterfilter++) {
  if(graduates[filterfilterfilterfilterfilterfilterfilter].university.toLowerCase().indexOf("uni") >= 0) uni.push(graduates[filterfilterfilterfilterfilterfilterfilter].university);
}
console.log(uni);
