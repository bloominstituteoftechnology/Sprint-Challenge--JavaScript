...
const tyrannosaurus = {diet: "carnivorous", weight: "7000kg", length: "12m", period: "Late Cretaceious", roar: function() {
...
for(i=0;i<zooAnimals.length;i++){
  populationTotal = zooAnimals.reduce(function(total, pop){
