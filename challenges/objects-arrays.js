...
universities.sort();
console.log(universities); //Completed
...
let lowerCase = zooAnimals.map((animal, index, animals) => {
  return animal.animal_name.toLowerCase();
});
console.log(lowerCase); //Completed
...
console.log(populationTotal); //Completed
