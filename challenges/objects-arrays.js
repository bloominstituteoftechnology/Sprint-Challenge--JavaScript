...
console.log(unisWithUni);//THIS NEEDS TO BE FIXED 
...
zooAnimals.forEach(function(currentValue){
  return displayNames.push(`Animal Name: ${currentValue.animal_name}, Scientific Name:${currentValue.scientific_name}`)
})
