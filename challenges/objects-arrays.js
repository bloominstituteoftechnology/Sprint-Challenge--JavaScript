...
*/
const largerPopulation = zooAnimals.filter(data => data.population < 5);
...
*/
const populationTotal = zooAnimals.reduce((totalPopulation, item) => totalPopulation + item.population, 0)
