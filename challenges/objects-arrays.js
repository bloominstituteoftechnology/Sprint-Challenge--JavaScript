...
for (let i = 0; i < graduates.length; i++) {
  let universityObj = {};
  universityObj = graduates[i].university;
  universities.sort().push(universityObj)
}
...
for (let i = 0; i < graduates.length; i++) {
  let contactObj = {};
  contactObj = `${graduates[i].first_name} ${graduates[i].email}`;
...
for (let i = 0; i < graduates.length; i++) {
  ...
  return graduates[i].university.push(uniObj);
}
console.log(uni);
...
*/
const animalNames = zooAnimals.forEach((animalName) => {
  console.log(`Name: ${animalName.animal_name}, Scientific: ${animalName.scientific_name}`)
})
...
const lowerCase = zooAnimals.map((smallFont) => {
  return {animal_name: smallFont.animal_name.toLowerCase()}})
