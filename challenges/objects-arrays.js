...
let names = zooAnimals.forEach(function(){
  animalNames.push("Name: " + zooAnimals[0] + "ScientificName: " + zooAnimals[2] )  
});
...
*/
const populationTotal = zooAnimals.reduce((total, population) => total + population);
