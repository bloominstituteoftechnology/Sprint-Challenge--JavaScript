...
function Dino([ diet, weight, length, period ]) {
  this.diet = diet;
  this.weight = weight;
  this.length = length;
  this.period = period;
...
const tyrannosaurus = new Dino([ 'carnivorous', '7000kg', '12m', 'Late Cretaceious' ]);

// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic
const stegosaurus = new Dino([ 'herbivorous', '2000kg', '9m', 'Late Jurassic' ]);

// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceious
const velociraptor = new Dino([ 'carnivorous', '15kg', '1.8m', 'Late Cretaceious' ]);
...
*/
const populationTotal = zooAnimals.reduce((acc, { population }) => acc + population, 0);
