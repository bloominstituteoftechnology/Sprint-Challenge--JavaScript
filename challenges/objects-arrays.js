...
for (let student of graduates) contactInfo.push(`${ student.first_name } ${ student.email }`);
...
for (let student of graduates) if (/Uni/.test(student.university)) uni.push(student.university);
