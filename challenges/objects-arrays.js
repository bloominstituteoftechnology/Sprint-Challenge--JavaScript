...
zooAnimals.filter(zooAnimals => {
  if (zooAnimals.population < 5) {
    largerPopulation.push(`${zooAnimals.animal_name} population: ${zooAnimals.population}.`);
  }
});
...
*/
let populationTotal = [];
populationTotal = zooAnimals.reduce((totalPop, zooAnimals) => {
  return totalPop + zooAnimals.population;
}, 0);
