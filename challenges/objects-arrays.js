...
*/
// class Dinosaur {
//   constructor(dinosaurOptions){
//     this.name = dinosaurOptions.name;
//     this.diet = dinosaurOptions.diet;
//     this.weight = dinosaurOptions.weight;
//     this.length = dinosaurOptions.length;
//     this.period = dinosaurOptions.period;
//   }
// }
...
for (var i = 0; i < zooAnimals.length; i++){
  populationTotal[0] += zooAnimals[i].population;
}
