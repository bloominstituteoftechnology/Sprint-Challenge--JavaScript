console.log("<---------------------Assignment objects-arrays's: Start--------------------->");
// ==== Objects ====
...
zooAnimals.forEach(element => {
  return animalNames.push(`Name: ${element.animal_name}, Scientific: ${element.scientific_name}.`);
});
...
zooAnimals.map(item => largerPopulation.push(item)).filter(item => item.population < 5);
...
console.log("<---------------------Assignment objects-arrays's: End--------------------->");