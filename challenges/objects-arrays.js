...
//   return populationTotal.push(x+y.population);
// });

// zooAnimals.forEach((item) => {
//   return item.population
// }).reduce((sum, item) =>{
//   return populationTotal.push((sum + item.population))
// });

// populationTotal.push(zooAnimals.reduce(function(sum, y){
//   return sum + y.population;
// }));
