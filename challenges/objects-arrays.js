...
// const largerPopulation = zooAnimals.filter(animal => animal.population < 5).map(i => i.animal_name)
...
// const populationTotal = zooAnimals.reduce( (total, zooPop) => total + zooPop.population, 0);
