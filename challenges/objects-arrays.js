...
zooAnimals.map(function(animal) {
  return lowerCase.push(`name: ${animal.animal_name.toLowerCase()}`)
});
...
*/
const largerPopulation = zooAnimals.filter(function(lowPopulation) {
...
*/
const populationTotal = zooAnimals.reduce(function(reducer, totalPopulation) {
