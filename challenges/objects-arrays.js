...
0Using filter, create a new array of objects called lowPopulationAnimals which contains only the animals with a population less than 5.
...
const populationTotal = zooAnimals.reduce(
  (populationTotal, animal) => (populationTotal += animal.population),
  0
);
