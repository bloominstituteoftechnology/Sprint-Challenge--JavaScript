...
console.log(tyrannosaurus.weight); // logs 7000kg
// What was the diet of a velociraptor?
console.log(velociraptor.diet); // logs carnivorous
// How long was a stegosaurus?
console.log(stegosaurus.length); // logs 9m
// What time period did tyrannosaurus live in?
console.log(tyrannosaurus.period); // logs Late Cretaceious

// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(tyrannosaurus.roar()); // logs RAWERSRARARWERSARARARRRR!
...
const lowerCase = [];
let convertToLower = (animal) => {
  return animal.animal_name.toLowerCase();
}
lowerCase.push(zooAnimals.map(convertToLower));
...
console.log(populationTotal.reduce(addTotal));