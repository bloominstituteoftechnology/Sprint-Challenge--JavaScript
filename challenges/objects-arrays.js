...
function Dinosaur (parms){
    this.name = parms.name
    this.diet = parms.diet
    this.weight = parms.weight
    this.length = parms.length
...
let populationTotal = zooAnimals.reduce((acc, curAnimal) => acc + curAnimal.population, 0);
