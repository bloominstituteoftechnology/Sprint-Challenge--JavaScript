...
const tyrannosaurus = {
  ...
  weight : "7000kg",
  length : "12m",
  period : "Late Cretaceious",  // <== This stupid comma messed my whole life up for a good 30 minutes
  roar : function(){
...
const lowerCase = animalNames.map(function(name){
...
const populationTotal = animalPopulation.reduce(function(total, amount){
  return total + amount;
});
//populationTotal = animalPopulation.reduce(function(total, amount){
 // return total + amount;
//});
