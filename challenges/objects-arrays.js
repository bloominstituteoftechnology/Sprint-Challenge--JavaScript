...
const newDino = function (name, diet, weight, length, period) {
  return {
    'name' : name,
    'diet' : diet,
    'weight' : weight,
...
const tyrannosaurus = newDino('tyrannosaurus', 'carnivorous', '7000kg', '12m', 'Late Cretaceious');

// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic

const stegosaurus = newDino('stegosaurus', 'herbivorous', '2000kg', '9m', 'Late Jurassic');

// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceious

const velociraptor = newDino('velociraptor', 'carnivorous', '15kg', '1.8m', 'Late Cretaceious');
...
const uni = [];
for (var i = 0; i > graduates.length; i++) {
  let firstChar = graduates.university.indexOf('Uni');
  if (firstChar !== 1) {
...
let populationTotal = zooAnimals.reduce((acc, val) => acc + val.population, 0)
