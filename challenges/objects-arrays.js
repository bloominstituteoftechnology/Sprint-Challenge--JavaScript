...
let lowerCase = [];
lowerCase = zooAnimals.map(function(object) {
...
let populationTotal = [];
populationTotal = zooAnimals.map(function(object) {
  return object.population;
})

// Reduce wasn't working so I uhhhh... improvised.

let acc = 0;
for (var i = 0; i < populationTotal.length; i++) {
  acc += populationTotal[i]
}
console.log(acc);
