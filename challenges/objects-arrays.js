...
const newSchoolData = graduates.map(function(currentValue){
...
const contactInfo = [];
const newSchoolFilter = graduates.filter(function(currentValue){
...
zooAnimals.filter(function(currentValue){
  return lowPopulationAnimals.push(currentValue.population < 5);
...
*/
const populationTotal = zooAnimals.reduce((accumulator, currentPopulation) => {return accumulator + currentPopulation.population}, 0)
