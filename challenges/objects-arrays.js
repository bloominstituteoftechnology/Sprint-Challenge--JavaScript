...
let lowerCase = [];
zooAnimals.forEach(element => lowerCase.push(element.animal_name));
lowerCase = lowerCase.map(x => x.toLowerCase());
console.log(lowerCase);

// The zoos need to know their total animal population across the United States.  Add up all the population numbers from all the zoos using the .reduce() method.
let populationTotal = [];
zooAnimals.forEach(element => populationTotal.push(element.population));
populationTotal = populationTotal.reduce((total, populationNumber) => total + populationNumber);
