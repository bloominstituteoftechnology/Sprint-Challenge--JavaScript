...
uni = uni.map(eachUni => eachUni.university);
console.log(uni);
...
//  ES6
animalNames = zooAnimals.map(animal => {'Name: '+ animal.animal_name+', Scientific: '+animal.scientific_name});
console.log(animalNames);
...
//  ES6
populationTotal = zooAnimals.reduce((totalPopulation, animal) => totalPopulation + animal.population, 0);
console.log(populationTotal);
