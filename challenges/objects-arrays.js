...
const alphaUnis = universities.sort();
console.log(alphaUnis);
...
const lowanimalNames = [zooAnimals.map(animal => animal.animal_name.toLowerCase())];
...
*/
const lowerPopulation = [zooAnimals.filter(populations => population < 5)];
