...
console.log(`The diet of the velociraptor was ${velociraptor.diet}.`);

// How long was a stegosaurus?
console.log(`A stegosaurus was ${stegosaurus.length} in length.`);

// What time period did tyrannosaurus live in?
console.log(`A tyrannosaurus lived during the ${tyrannosaurus.period}.`);
...
const animalCount = zooAnimals.map(animal => animal.population);
const populationTotal = animalCount.reduce(reducer, 0);
