...
const lowerCase = [];
zooAnimals.forEach(function(lowName){
  lowerCase.push(lowName.animal_name.toLowerCase() );
}
);
console.log(lowerCase); 

// The zoos need to know their total animal population across the United States.  Add up all the population numbers from all the zoos using the .reduce() method.
const populationTotal = zooAnimals.reduce(function(totalPopulation, item) {
  return totalPopulation + item.population;
  }, 0);;;
