...
tyran.roar = function(){return "RAWERSRARARWERSARARARRRR!"}
...
let universities = [];
const uniUnsorted = []
graduates.forEach(element => uniUnsorted.push(element.university))
universities = uniUnsorted.sort()
...
zooAnimals.map(element => lowCaseAnimalNames.push(element.animal_name.toLocaleLowerCase()))
...
populationTotal = zooAnimals.reduce((acummulator, currentValue) => {return acummulator += currentValue.population},0);
