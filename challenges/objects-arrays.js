...
console.log(tyrannosaurus.status());
...
const universities = graduates.map(function(currntv){
  return currntv.university;
});
universities.sort();
...
// const uni = graduates.forEach(function(currentvalue){
...
*/
animal_name.forEach(animal_name => {
