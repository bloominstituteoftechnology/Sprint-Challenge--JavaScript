...
//const displayNames = zooAnimals.forEach((object) => { displayNames.push(object.animal_name, object.scientific_name);
//})
...
//const populationTotal = zooAnimals.reduce((accumlator, currentValue) => accumlator + currentValue; );