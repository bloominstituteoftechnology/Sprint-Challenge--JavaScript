...
const animalNames = [];
zooAnimals.forEach(function(fullName){
  animalNames.push(`${fullName.animal_name} ${fullName.scientific_name}`);
});
...
zooAnimals.reduce(function(accumlator, currentValue){
    return accumlator + currentValue.population
}, 0);
