...
const lowerCase = [];
let zooLength = zooAnimals.length;
for (let i= 0; i< zooLength; i++) {
...
populationTotal.push(zooAnimals.reduce((count, all) => count + all.population, 0))
