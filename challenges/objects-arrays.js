...
const universities = [];
graduates.map((unis) => universities.push(unis.university));
console.log(universities.sort());

//pre arrow function
// const universities = [];
// graduates.map(function(unis){
...
const contactInfo = [];
graduates.map((item) => contactInfo.push(`${item.first_name} ${item.email}`));
...
// option 1, stuck....not sure...for loop?
// const unisWithUni = [];
// graduates.includes(function(item){
//   unisWithUni.push(`${item.university('uni')}`); 
// });
// console.log(unisWithUni); 
// for loop?
...
// option 1 using let....how can I do the same without deleting const?...solution
