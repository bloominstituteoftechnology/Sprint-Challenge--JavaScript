...
// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log 
//the result.
...
The resulting contact information should have a space between the first name and the email i
nformation like this: 
...
converted to lower case.  Create a new array named lowerCase and map over each name 
to convert them all to lower case.  Log the result.
...
The zoos are concenred about animals with a lower population count. Find out which
 animals have a population less than 5.
...
*/
const populationTotal = zooAnimals.reduce((total, popAmt) => {
 return total + popAmt.population;
}, 0);
