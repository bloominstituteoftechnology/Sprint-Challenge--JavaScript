...
console.log(tyrannosaurus.period);//Late Creteceious
...
const universities = graduates.map( (array) => {
...
const contactInfo = graduates.map( (array) =>{
  return "Name: "+ array.first_name + "  Email: "   + array.email;
});
console.log(contactInfo);


/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called uni that contains them all. Log the result. */
const uni = graduates.filter( (array) => {
...
const lowerCase = zooAnimals.map( (array) => {
