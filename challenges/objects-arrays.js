...
// const universities [];
const universities = graduates.map((university, index) => {
...
//const lowerCase = [];
const lowerCase = zooAnimals.map((zooAnimals, index) => {
...
lowerPupulation = zooAnimals.filter(animal => zooAnimals.population <= 5);
