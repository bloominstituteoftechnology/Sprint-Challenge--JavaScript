...
var velociraptor = {weight: '15kg', diet: 'carnivorous', length:'1.8m', period:'Late Cretaceious'};
...
let animalNames = [];
  ...
  let sciNames = zooAnimals.forEach((zooAnimals, index, zooAnimal) => {
    return zooAnimals.scientific_name + zooAnimals

  animalNames.push(sciNames)
