...
*/
const animalNames = [];
const animalNaming = zooAnimals.forEach(function(i){
...
*/
const largerPopulation = zooAnimals.filter(function(lessThan){
  return lessThan.population <= "5"
});
...
*/
const populationTotal = zooAnimals.reduce(function(populationAnimals, populationAmount){
  return populationAnimals + populationAmount.population;
}, 0);
