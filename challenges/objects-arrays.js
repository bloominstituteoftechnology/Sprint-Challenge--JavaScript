...
const uni = [];
for (x=0; x<universities.length; x++) {
  (universities[x].includes ("Uni")) ? uni.push(universities[x]) : null;
  }
...
const largerPopulation = zooAnimals.filter(larPop => larPop.population<5);
