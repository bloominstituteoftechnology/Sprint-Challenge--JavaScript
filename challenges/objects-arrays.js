...
{ "id": 9, "first_name": "Michail", "university": "Universidad CatÃ³lica de Ã�vila", "email": "mrome8@shinystat.com" },
...
const populationTotal = zooAnimals.map(animals => animals.population).reduce((a, b) => a + b);
