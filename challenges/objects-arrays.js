...
object1.roar = ()=> "RAWERSRARARWERSARARARRRR!"
...
lowPopulationAnimals.push(zooAnimals.filter(item=>item.population<5));
...
const popu = zooAnimals.map(item=>item.population);
const populationTotal = popu.reduce((acc,total)=>acc+=total);
