...
const animalNames = [];
  zooAnimals.forEach(function(zooAnimals){
    animalNames.push(`Name: ${zooAnimals.animal_name}, Scientific Name: ${zooAnimals.scientific_name}`)
  });
...
const lowerCase = zooAnimals.map(function(zooAnimals){
  return `Name: ${zooAnimals.animal_name.toLowerCase()}`
});
...
const populationTotal = zooAnimals.reduce(function(totalPopulation, zooAnimals){
  return totalPopulation + zooAnimals.population;
}, 0);
