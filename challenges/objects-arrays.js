...
const animalNames = () => {
  let newAnimals = [];
  zooAnimals.forEach(animal => newAnimals.push(animal.scientific_name));
  return newAnimals;
};
...
// * returs ugly object
const populationTotalUgly = zooAnimals.reduce((accumulator, currentValue) => ({
  population: accumulator.population + currentValue.population
}));
console.log(populationTotalUgly);

// * returns pretty value
const populationTotal = () => {
  const obj = zooAnimals.reduce((accumulator, currentValue) => ({
    population: accumulator.population + currentValue.population
  }));
