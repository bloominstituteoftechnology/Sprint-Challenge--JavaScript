...
let lowerCase = zooAnimals.map(each => each.animal_name.toLowerCase());

console.log(lowerCase); 

// The zoos need to know their total animal population across the United States.  Add up all the population numbers from all the zoos using the .reduce() method.
const reducer = (acc, each) => acc + each.population;
let populationTotal = zooAnimals.reduce(reducer,0); // Copied MDN here to debug, that pesky second argument was the problem.  I'll refactor later.
