...
const graduates = [{"id":1,"first_name":"Cynde","university":"Missouri Southern State College","email":"ctorry0@macromedia.com"},
 ...
 function getUniversities(items) {
 ...
 const uni = []
 let includesUni = graduates.includes(word => word.filter() === "uni");
...
*/
 ...
 const animalNames = [animal_name + scientific_name];

 zooAnimals.forEach(zooAnimals => console.log(animalNames));
 ...
 */
 ...
 const lowerCase = zooAnimals.map(zooAnimals, animal_name.toLowerCase);
...
const populationTotal = zooAnimals.reduce((popTotal, pop) => {
  return popTotal + pop;
})
