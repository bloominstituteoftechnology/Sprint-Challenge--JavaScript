...
for (let i = 0; i < universities.length; i++){
  if (universities[i].includes('u', 'n', 'i')){
...
lowerCase = zooAnimals.map(function(nameLow){
  return nameLow.animal_name.toLocaleLowerCase();
});
...
populationTotal = zooAnimals.reduce((pop, item) =>{
  return pop + item.population;
}, 0);
