...
// NOTE      ANSWER        ANSWER
// !!!  Added the .roar method to the tyrannosaurus object above
...
let lowerCase = zooAnimals.map(function nameToLowCase (animal) {
...
*/
let populationTotal = [];
let populationTotal = zooAnimals.reduce(function totalPop (runningTotal, animal) {
