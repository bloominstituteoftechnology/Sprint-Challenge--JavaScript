...
const biteyBitey = {'name':'tyrannosaurus', 'diet':'carnivorous', 'weight':'7000kg', 'length':'12m', 'period':'Late Cretaceious'};

// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic
const smashySmashy = {'name':'stegosaurus', 'diet':'herbivorous', 'weight':'2000kg', 'length':'9m', 'period':'Late Jurassic'};

// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceious
const stabbyStabby = {'name':'velociraptor', 'diet':'carnivorous', 'weight':'15kg', 'length':'1.8m', 'period':'Late Cretaceious'};

// Using your dinosaur objects, log answers to these questions:
console.log("\nDinosaurs\n--------------------");
// How much did tyrannosaurus weigh?
console.log(biteyBitey.weight);
// What was the diet of a velociraptor?
console.log(stabbyStabby.diet);
// How long was a stegosaurus?
console.log(smashySmashy.length);
// What time period did tyrannosaurus live in?
console.log(biteyBitey.period);

// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
biteyBitey.roar = function() {
return "RAWERSRARARWERSARARARRRR";
}

console.log(biteyBitey.roar());
...
for(i = 0; i < universities.length; i++) {
  if(universities[i].search("Uni") > -1){
...
zooAnimals.forEach(animal => populationTotals.push(animal.population));
let populationTotal = populationTotals.reduce((a, b) => a + b, 0);
