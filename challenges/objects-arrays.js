...
const largerPopAnimalNames = largerPopulation.map(function(animal){
  return animal.animal_name;
})
console.log(largerPopAnimalNames);
...
*/
const populationList = zooAnimals.map(function (animal) {
  return animal.population;
})
const populationTotal = populationList.reduce(function (accumulator, currentValue) {
