...
//console.log(typeof universities[0]); // string
...
//console.log(typeof contactInfo[0]); // string

/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called unisWithUni that contains them all. This will be an array of objects. Log the result. */
const unisWithUni = [];
function doesContain (element, arr) {
	let obj = { university: element };
	if(element.includes('Uni')) {
		arr.push(obj);
	}
}
universities.forEach(element => doesContain(element, unisWithUni));
console.log('unisWithUni:');
console.log(unisWithUni);

//console.log(typeof unisWithUni[0]); // object
...
//console.log(typeof displayNames[0]); // string
...
//console.log(typeof lowCaseAnimalNames[0]); // string
...
//console.log(typeof lowPopulationAnimals[0]); // object
