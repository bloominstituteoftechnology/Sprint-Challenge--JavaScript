...
universities.push(graduates[i].first_name);
universities.sort();
...
const addedPopulation=zooAnimals.reduce((populationTotal,zooAnimals.population)=>
   populationTotal+=zooAnimals.population,0);
