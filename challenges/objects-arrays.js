...
let lowerCase = [];
lowerCase = zooAnimals.map(x => {return x.animal_name.toLowerCase()});
console.log(lowerCase); 

// The zoos need to know their total animal population across the United States.  Add up all the population numbers from all the zoos using the .reduce() method.
let populationTotal = [];
populationTotal = zooAnimals.reduce((totalAnimals, animalValue) => { return totalAnimals + animalValue.population;}, 0);
