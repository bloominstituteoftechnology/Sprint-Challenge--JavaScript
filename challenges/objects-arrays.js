...
var velociraptor = {diet: "carnivorous", weight: "15kg", length: "1.8m", period: "Late Cretaceous"};
...
/* Request 1: Create a new array called universities that contains all the universities 
...
The resulting contact information strings should have a space between the first name 
and the email, like this: 
...
The zoos need a list of all their animal's names (animal_name only) converted to 
lower case. Using map, create a new array of strings named lowCaseAnimalNames, each string 
...
population from all the zoos using the .reduce() method. Remember the reduce method takes 
