...
const tyrannosaurus = new Tyrannosaurus("tyrannosaurus", "carnivorous", "7000kg", "12m", "Late Cretaceious")
...
// grab univeristies
const universities = graduates.map( (g) => { return g.university} ).sort();
...
const contactInfo = graduates.map( (g) => { return g.first_name + " " + g.email});
console.log(contactInfo);


/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called uni that contains them all. Log the result. */
const uni = [];
graduates.forEach( (e) => { if(e.university.includes("Uni")) uni.push(e.university) });
console.log(uni);
...
let lowerCase = zooAnimals.map( (a) => {return a.animal_name.toLowerCase()});
console.log(lowerCase);

// The zoos need to know their total animal population across the United States.  Add up all the population numbers from all the zoos using the .reduce() method.
let populationTotal = zooAnimals.reduce( (t, v) => {return t + v.population}, 0);
