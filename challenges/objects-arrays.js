// ==== Objects ====
console.warn('objects-arrays.js');
/* 
...
// const uni = universities.filter(u => {
//   return u.includes('Uni') === true;
// });
let uni = [];
...
const animalNames = [];
//did it this way to not mutate zooAnimals array.
zooAnimals.forEach(a => {
  let obj = {
    animal_name: a.animal_name,
    scientific_name: a.scientific_name
  }
  let str = `Name: ${obj.animal_name}, Scientific: ${obj.scientific_name}.`
...
const lowerCase = zooAnimals.map(a => {
...
*/
//Why call it largerPopulation if they are the ones with less than 5?
//Just following big boss' orders...
const largerPopulation = zooAnimals.filter(a => {
...
*/
const populationTotal = zooAnimals.reduce((total, curr) => {
