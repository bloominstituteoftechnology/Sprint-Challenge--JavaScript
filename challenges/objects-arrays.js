...
const tyrannosaurus = {diet: "carnivorous", weight: 7000 + "kg", length: 12 + "m", period: "Late Cretaceious"};

// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic
const stegosaurus = {diet: "herbivorous", weight: 2000 + "kg", length: 9 + "m", period: "Late Jurassic"};

// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceious
const velociraptor = {diet: "carnivorous", weight: 15 + "kg", length: 1.8 + "m", period: "Late Cretaceious"};
...
const populationTotal = zooAnimals.map(animal => animal.population).reduce((acc, cV) => acc + cV);
