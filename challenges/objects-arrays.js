...
for (i=0; i<graduates.length;i++){
  (universities.push(graduates[i].university)) //this is what map does under the hood....
}
universities.sort();
...
for (i=0; i<graduates.length;i++){
  var regEx = /[U][n][i]/ig;
  var find = graduates[i].university.match(regEx);
  if (find){
...
let reduced = zooAnimals.reduce(function (acc, animal) { 
