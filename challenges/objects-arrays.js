...
Object.create=tyrannosaurus.roar=function(){return "RAWERSRARARWERSARARARRRR!"};
// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic
let stegosaurus={name:'Stegosaurus',diet:'Herbivorous',weight:'2000kg',length:'9m', period:'Late Jurassic'};
// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceious
let velociraptor={name:'Velociraptor',diet:'Carnivorous',weight:'15kg',length:'1.8m', period:'Late Cretaceious'};
