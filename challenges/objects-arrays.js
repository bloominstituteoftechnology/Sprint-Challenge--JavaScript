...
for (let i = 0; i < zooAnimals.length; i++){
  ...
  var zooAnimalsLowerCase = zooAnimals[i].animal_name.toLowerCase();
  lowerCase.push(zooAnimalsLowerCase);
...
populationTotal.push(zooAnimals.reduce((accum, zooAnimals)=> {
  return accum += zooAnimals.population}, 0));
