...
function ObjectCreation(name,diet,weight,length,period){
    this.name = name;
    this.diet = diet;
    this.weight = weight;
    this.length = length;
...
let tyrano = new ObjectCreation("tyrannosaurus", "carnivorous", "7000kg", "12m", "Late Cretaceious");


// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic
let stego = new ObjectCreation("stegosaurus", "herbivorous", "2000kg", "9m", "Late Jurassic");

// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceious
let velo = new ObjectCreation("velociraptor", "carnivorous", "15kg", "1.8m", "Late Cretaceious");
...
*/
// get An array containing only population then use the reduce method on it.
let populationArray = [];
for(let i = 0 ; i < zooAnimals.length ; i++){
    populationArray.push(zooAnimals[i].population);
}
// use the reduce method on my population array
let populationTotal = populationArray.reduce((total,element)=>{
...
let lowerCase1 = zooAnimals.map((element)=>{return element.animal_name.toLowerCase();})

const largerPopulation1 = zooAnimals.filter((element)=>{return element.population < 5;})

let populationTotal2 = populationArray.reduce((total,element)=>{return total +=element;})
