...
const universities = ["Coastal Carolina University","Fachhochschule Rosenheim, Hochschule für Technik und Wirtschaft","International Medical & Technological University","Marian College","Missouri Southern State College","Salem University","Sultan Salahuddin Abdul Aziz Shah Polytechnic","The School of the Art Institute of Chicago","Universidad Católica de Ávila","Universitat Rovira I Virgili Tarragona"];
console.log(universities.values)
...
const contactInfo = ["Cynde ctorry0@macromedia.com","Saundra swhal1@state.gov","Lambert lparham2@techcrunch.com","Modestinem mdolder3@symantec.com","Chick camorts4@google.com.au","Jakob jharken5@spiegel.de","Robbi rbrister6@redcross.org","Colline rbrister6@redcross.org","Michail mrome8@shinystat.com","Hube hlethbrig9@foxnews.com"];
console.log(contactInfo.values)


/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called uni that contains them all. Log the result. */
const uni = ["Universidad Católica de Ávila","Universitat Rovira I Virgili Tarragona"];
