...
*/
let dinosaurs = function(name, diet, weight, length, period) {
this.name = name;
this.diet = diet;
this.weight = weight;
this.length = length;
...
let tyrannosaurus = new dinosaurs('tyrannosaurus', 'carnivorous', '7000kg', '12m', 'Late Cretaceious')

let stegosaurus = new dinosaurs('stegosaurus', 'herbivorous', '2000kg', '9m', 'Late Jurassic')

let velociraptor = new dinosaurs('velociraptor', 'carnivorous', '15kg', '1.8m', 'Late Cretaceious')
...
const universities = [];
function universityNames(object) {
...
let populationTotal = zooAnimals.reduce((sum, animal) => {
