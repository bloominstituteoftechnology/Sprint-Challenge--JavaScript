...
const uni = universities.filter(hasUni => hasUni.includes('Uni'));
console.log(uni);
...
let lowerCase = zooAnimals.map(animals => animals.animal_name.toLowerCase());
console.log(lowerCase); 

// The zoos need to know their total animal population across the United States.  Add up all the population numbers from all the zoos using the .reduce() method.
let populationTotal = zooAnimals.reduce((total,aniPop) => (total += aniPop.population),0);
