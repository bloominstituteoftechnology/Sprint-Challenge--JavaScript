...
var tyrannosaurus = [{name: "tyrannosaurus", diet: "carnivorous", weight: "7000kg", length: "12m", period: "Late Cretaceious",}];
// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic
var stegosaurus = [{name: "stegosaurus", diet: "herbivorous", weight: "2000kg", length: "9m", period: "Late Jurassic",}];
// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceious
var velociraptor = [{name: "velociraptor", diet: "carnivorous", weight: "15kg", length: "1.8m", period: "Late Cretaceious",}];
...
for(let i = 0; i < graduates.length; i++){
  const universities = [graduates[i].first_name];
}
