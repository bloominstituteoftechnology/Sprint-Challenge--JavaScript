...
const universities = graduates.map((students) => {return students.university});
...
const contactInfo = graduates.map((contact) => {return contact.first_name + " " + contact.email});
...
*/
const populationTotal = zooAnimals.reduce((accumulator, currentValue) => currentValue.population + accumulator, 0);
