...
// Given an array of college graduates.  Complete the following 
//requests without using any array methods like .forEach(), .map(), .reduce(), .filter()
...
/* Request 1: Create a new array called universities that contains 
//all the univeristies in the graduates array.  
...
/* Request 2: Create a new array called contactInfo that contains 
both first name and email of each student. 

The resulting contact information should have a space between 
the first name and the email information like this: 
