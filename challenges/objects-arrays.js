...
console.log(`The Tyrannosaurus lived in the ${tyrannosaurus.period} era.`);
...
zooAnimals.map(function(str) {
  lowCaseAnimalNames.push(str.animal_name.toLowerCase());
})
...
let lowPop = (obj) => obj.population < 5;
...
let populationTotal = zooAnimals.reduce((population, zooAnimal) => { return population +=+zooAnimal.population; }, 0);
