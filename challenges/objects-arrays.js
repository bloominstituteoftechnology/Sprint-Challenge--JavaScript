...
console.log(uni);
console.log(`There are ${uni.length} universities with \"Uni\" in their name`);
...
const populationTotal = zooAnimals.reduce((accu, animal) => accu + animal.population, 0);
