...
const universities = [];
let newArrUniversities = graduates.forEach(function(i){
...
const contactInfo = [];
let namEmail = graduates.forEach(function(i){
...
// const uni = [];
// let uniArr = graduates.filter((i) => {
//     uni.push(universities.includes('Uni'));
// });
// console.log(uni);
...
let lowerCase = [];
let allLow = zooAnimals.map((i) =>{
  return lowerCase.push(i.animal_name.toLowerCase());
})
console.log(lowerCase); 

// The zoos need to know their total animal population across the United States.  Add up all the population numbers from all the zoos using the .reduce() method.
// let populationTotal = [];
let zooTotal = zooAnimals.reduce((total, num) => {
