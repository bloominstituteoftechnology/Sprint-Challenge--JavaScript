...
for (let i = 0; i < graduates.length; i++) {
  const sorted = graduates[i].university;
  universities.push(sorted);
}
...
for (i = 0; i < graduates.length; i++) {
  if (graduates[i].university === "Universidad Católica de Ávila" || graduates[i].university === "Universitat Rovira I Virgili Tarragona") {
