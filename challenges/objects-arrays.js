...
// How much did tyrannosaurus weigh? 7000 kg
console.log(tyrannosaurus.weight);
// What was the diet of a velociraptor? carnivorous
console.log(velociraptor.diet);
// How long was a stegosaurus? 9m
console.log(stegosaurus.length);
// What time period did tyrannosaurus live in? Late Cretaceous
...
let lowerCase = [];
lowerCase=zooAnimals.map((e)=>e.animal_name.toLowerCase());
console.log(lowerCase); 

// The zoos need to know their total animal population across the United States.  Add up all the population numbers from all the zoos using the .reduce() method.
let populationTotal = [];
populationTotal=zooAnimals.reduce((populationTotal,populationCount)=>populationTotal+=populationCount.population,0);
