...
const mappedContactInfo = graduates.map((contact) => 
{
  return {'name': contact.first_name, 'email':contact.email};
})

console.log(".map version");

console.log(mappedContactInfo);
...
console.log("how many universities have the string 'Uni' included in their name: " + unisWithUni.length);
...
console.log(`The current zoo animal population is: ` + populationTotal);
