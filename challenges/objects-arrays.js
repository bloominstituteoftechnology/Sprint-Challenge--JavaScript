...
zooAnimals.forEach(function (names) {
  bothNames.push(`${names.animal_name}, ${names.scientific_name}.`)
})
...
zooAnimals.filter(function(lowNumber) {
  return lowNumber.population < 5
});
...
const populationTotal =
  zooAnimals.reduce(function (total, number) {
