...
console.log(`The diet of ${velociraptor.name} was ${velociraptor.diet}.`);

// How long was a stegosaurus?
console.log(`${stegosaurus.name} was ${stegosaurus.length} long.`);
...
let populationTotal = [];
populationTotal = zooAnimals.reduce(function(counter, zooAnimals) {
