...
console.log(stegosaurus.lengthProp);
...
const universities = [];
graduates.forEach(graduates => universities.push(graduates.university));  //use .map()?
universities.sort();
...
The zoos need to know their total animal population across the United States. Find the total population from all the zoos using the .reduce() method. Remember the reduce method takes two arguments: a callback 
