...
// const populationTotal = zooAnimals.reduce((total, nextAnimal) => total + nextAnimal.population);
const populationTotal = zooAnimals.reduce(function(total, nextAnimal) {
  return total + nextAnimal.population;
}, 0);
