...
zooAnimals.forEach(animal => {
  let suggestedDisplay = 'Name:' + animal.animal_name + ', Scientific: ' + animal.scientific_name;
  animalNames.push(suggestedDisplay);
});
...
const populationTotal = zooAnimals.reduce((accumulator, currentValue) => { return accumulator + currentValue.population }, 0);
