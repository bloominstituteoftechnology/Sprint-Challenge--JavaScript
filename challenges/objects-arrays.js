...
*/
const animalNames = [];
zooAnimals.forEach(function(elem) {
	animalNames.push(`Name: ${elem.scientific_name}, Scientific: ${elem.animal_name}`);
});
...
const lowerCase = [];
lowerCase.push(
	zooAnimals.map(function(elem) {
		return elem.scientific_name.toLowerCase();
	})
);
...
*/
const largerPopulation = zooAnimals.filter(function(elem) {
