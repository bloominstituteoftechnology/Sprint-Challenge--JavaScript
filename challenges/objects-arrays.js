...
console.log(tyrannasaurus.weight + "kg");
...
console.log(tyrannasaurus.period);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(tyrannasaurus.roar());
...
zooAnimals.forEach(e=> {
  animalNames.push(e.animal_name, e.scientific_name)
})
...
const endangered = zooAnimals.filter((e)=> e.population<5
 
)
largerPopulation.push(endangered)
...
popu = [];
 zooAnimals.forEach(e=>{
   popu.push(e.population)
 })

const populationTotal = popu.reduce(function(passed,item){
  return passed +=item;
}, 0);
