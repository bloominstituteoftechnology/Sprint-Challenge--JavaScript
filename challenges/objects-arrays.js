...
*/
const displayNames = [];
zooAnimals.forEach(function(habitats){
  displayNames.push('Name:' + habitats.animal_name, 'Scientific:'+ habitats.scientific_name + '.');
})
...
*/
const populationTotal = zooAnimals.reduce((animal, total) => {
