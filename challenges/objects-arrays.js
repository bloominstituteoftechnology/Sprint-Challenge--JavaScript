...
zooAnimals.forEach((zooAnimals) => animalNames.push `${zooAnimals.animal_name} ${zooAnimals.scientific_name}`)
...
*/
const populationTotal = zooAnimals.reduce((int, population) => int + zooAnimals.population, 0);
