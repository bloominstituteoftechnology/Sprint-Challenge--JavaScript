...
The zoos are concered about animals with a lower population count. Find out which animals have a population less than 5.

*/
const largerPopulation = zooAnimals.filter((animal) => animal.population < 5 ? true : false);
