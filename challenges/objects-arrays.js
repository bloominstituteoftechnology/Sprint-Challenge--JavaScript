...
zooAnimals.filter((lowPop) => {
  ...
  largerPopulation.push(`${lowPop.animal_name} has a population of ${lowPop.population}`)
})
...
*/
const populationTotal = zooAnimals.reduce((pop, total) =>{
  return pop + total.population
}, 0);
console.log("total population of all zoo animals:", populationTotal);
