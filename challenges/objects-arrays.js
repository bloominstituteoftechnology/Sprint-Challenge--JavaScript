...
const uni = [];
for(let i = 0; i < graduates.length; i++){
  if(graduates[i].university.includes("Uni") && !uni.includes(graduates[i].university)){
...
The zoos need a list of all their animal's names (names only, not scientific) converted to lower case.  Create a new array named l
// owerCase and map over each name to convert them all to lower case.  Log the resut.
