...
console.log(id1.weight);

// What was the diet of a velociraptor?
console.log(id3.diet);

// How long was a stegosaurus?
console.log(id2.length);

// What time period did tyrannosaurus live in?
console.log(id1.period);

// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
id3.roar = 'RAWERSRARARWERSARARARRRR';
console.log(id3.roar);
...
const universities =  graduates.map((graduates) => {
  return {'universities': graduates.university}; 
});

let sortedUniversities = universities.sort((universities) => {
  return {'sortedUniversities': universities};
});
...
const contactInfo = graduates.map((graduates) => {
  return {'contactInfo': graduates.first_name + " " + graduates.email};
});

console.log(contactInfo);

/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called unisWithUni that contains them all. This will be an array of objects. Log the result. */
// const unisWithUni = function graduates.match(/uni/) {
//   return {'includedUni': graduates.university};
// }; 
...
*/
const displayNames = zooAnimals.forEach((zooAnimals) => {
...
const lowCaseAnimalNames = zooAnimals.map((zooAnimals) => {
  return {'lowCaseAnimalNames': zooAnimals.animal_name.toLowerCase()};
