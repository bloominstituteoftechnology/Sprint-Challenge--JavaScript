...
for (i=0; i < graduates.length; i++){
  const get = graduates[i]
  universities.push(get.university)
}
...
*/
const displayNames = [];
const display = zooAnimals.forEach(function(names){
...
*/
const lowPopulationAnimals = zooAnimals.filter(function(lowPopulation){
...
const animalsPop = zooAnimals.reduce(function(accumlator, zooAnimal){
 return accumlator + zooAnimal.population
  }, 0)
// console.log(populationTotal);
console.log(animalsPop)
