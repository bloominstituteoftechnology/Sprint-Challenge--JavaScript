...
const contactInfo = [];
graduates.map(students => contactInfo.push(`${students.first_name} ${students.email}`))
console.log(contactInfo);


/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called uni that contains them all. Log the result. */
let uni = [];
uni = graduates.filter(students => students.university.includes('Uni') === true);
// graduates.forEach(student => {
//   let school = student.university.includes('Uni');
//   if(school) {
