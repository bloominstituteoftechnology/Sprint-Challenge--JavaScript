...
/* 
  ...
  Use  pattern to create your objects: 
...
The resulting contact information should have a space between the first name and the email information like : 
...
// Given  zoo data from around the United States, follow the instructions below
