...
// console.log(universities);
 ...
 const  university = graduates.map(function(element){
  let universities = element.university.toLowerCase();
  // return element.university.toLowerCase();
  return universities;
})
...
let contactInfo = graduates.map(info => {
  let newInfo = {};
  newInfo[info.first_name] = info.email;
  return newInfo
});
// const contactInfo = [];
