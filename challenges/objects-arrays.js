...
const stegosaurus = {name: 'stegosaurus', diet: 'herbivorous', weight: '7000kg', length: '9m', period: 'Late Jurassic'};
...
const contactInfo = [];
for(i = 0; i <graduates.length; i++){
  var studentInfo = ` ${graduates[i].first_name}, ${graduates[i].email}.`
