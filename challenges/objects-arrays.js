...
const unisWithUni = [];
unisWithUni.push(graduates.filter(graduates => graduates.university.includes("Uni")))
...
newArr = []
zooAnimals.forEach(zooAnimals => newArr.push(zooAnimals.population))
populationTotal.push(newArr.reduce((acc, cur) => acc + cur, 0))
