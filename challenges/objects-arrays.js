...
*/
const displayNames = [];
zooAnimals.forEach(function(beastie){
  displayNames.push(`Name: ${beastie.animal_name}, Scientific ${beastie.scientific_name}`)
});
...
const lowCaseAnimalNames = zooAnimals.map(function(beastie){
  return beastie.animal_name.toLowerCase();
});
...
*/
const lowPopulationAnimals = zooAnimals.filter(function(beastie){
  return beastie.population < 5;
});
...
*/
const populationTotal = zooAnimals.reduce(function(sum, animal){
