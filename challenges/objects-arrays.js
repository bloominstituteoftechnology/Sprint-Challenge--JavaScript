...
console.log(`The ${dinosaur.name} weighed ${dinosaur.weight}.`);

// What was the diet of a velociraptor?
console.log(`The ${dinosaur3.name} was ${dinosaur3.diet}.`);

// How long was a stegosaurus?
console.log(`The ${dinosaur2.name} was ${dinosaur2.length} long.`);

// What time period did tyrannosaurus live in?
console.log(`The ${dinosaur.name} lived in the ${dinosaur.period} period.`);
...
let sorteduniversities = universities.sort();
...
*/
const populationTotal = zooAnimals.reduce((Total, AnimalPopulation) => {
