...
zooAnimals.forEach(function(info){
  return displayNames.push(info.animal_name + " also known as " + info.scientific_name);
})
...
let lowPopulationAnimals = zooAnimals.filter(function(num){
...
let populationTotal = zooAnimals.reduce(function(accumulator, popNum){
  return accumulator + popNum.population;
}, 0)
