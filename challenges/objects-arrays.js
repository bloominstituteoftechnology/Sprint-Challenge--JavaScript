...
const animalNames = [];
zooAnimals.forEach(animals => animalNames.push('name: ' + animals.animal_name + ' scientific: ' + animals.scientific_name))
...
const lowerCase = zooAnimals.map(Obj => {return Obj.animal_name.toLowerCase()})
...
const largerPopulation = zooAnimals.filter(Obj => {return Obj.population < 5})
...
{return population += zooAnimals.population}, 0)
