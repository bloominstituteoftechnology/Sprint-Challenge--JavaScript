...
*/
const largerPopulation = zooAnimals.filter((animal) => {return animal.population < 5}).map((result) => {return result.animal_name});
...
*/
const populationTotal = zooAnimals.reduce((totalPopulation, animal) => {return totalPopulation + animal.population}, 0);
