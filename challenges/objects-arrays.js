...
zooAnimals.forEach(function(thisArray) {
	animalNames.push( `Name: ${thisArray.animal_name}, Scientific: ${thisArray.scientific_name}`);
});
...
const lowerCase = zooAnimals.map(function(thisArray){
	return thisArray.animal_name.toLowerCase();
});
...
const largerPopulation = zooAnimals.filter(function(thisArray) {
	return thisArray.population < 5;
});
