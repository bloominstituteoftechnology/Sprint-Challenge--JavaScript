...
// zooAnimals.forEach(zoos => {
//   displayNames.push(
//     `Name: ${zoos.animal_name}  Scientific: ${zoos.scientific_name}.`
//   );
// });
...
// const lowCaseAnimalNames = zooAnimals.map(zoos =>
//   zoos.animal_name.toLowerCase()
// );
...
*/
const populationTotal = zooAnimals.reduce(function(all, pop) {
  return all + pop.population;
}, 0);
