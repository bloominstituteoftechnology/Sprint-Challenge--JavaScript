...
zooAnimals.forEach(function(animal) {
  animalNames.push(animal.scientific_name + " " + animal.animal_name);
});
...
*/
let lowerPopulation = zooAnimals.filter(animal => {
...
*/
let populationTotal = [];
populationTotal = zooAnimals.reduce((totalPopulation, animal) => {
