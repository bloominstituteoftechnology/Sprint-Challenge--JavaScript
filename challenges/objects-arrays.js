...
zooAnimals.forEach(function(name) {
  animalNames.push(`${name.scientific_name} ${name.animal_name}`)
})
...
const lowerCase = [];
zooAnimals.map(function(smallCaps) {
  lowerCase.push(smallCaps.animal_name.toLowerCase())
});
...
*/
let largerPopulation = zooAnimals.filter((lowPop) => {
...
*/
let populationTotal = zooAnimals.reduce((total, sum) => {
