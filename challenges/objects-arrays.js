...
const lowCaseAnimalNames = zooAnimals.map(function lowerscase(animal) {
  return animal.animal_name.lowerCaseAnimalNames();
});
...
const largPopulationAnimals = zooAnimals.filter(
