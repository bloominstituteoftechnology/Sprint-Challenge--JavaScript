...
console.log(`There are ${uniCount} Universities with the string "uni" in their name`);
console.log(uni);
...
const reducePop = (acc, item) => {
  return acc + item.population;
}

populationTotal.push(zooAnimals.reduce(reducePop, 0));
