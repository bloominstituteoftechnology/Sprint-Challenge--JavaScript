...
class Roar extends Dinosaur {
	constructor(roarOptions) {
		super(roarOptions);
	}
	roar() {
...
let populationTotal = [];
populationTotal = zooAnimals.map(animal => animal.population).reduce((total, num) => total + num);
