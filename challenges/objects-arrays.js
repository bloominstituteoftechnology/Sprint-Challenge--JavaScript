...
const universities = ["Fachhochschule Rosenheim, Hochschule für Technik und Wirtschaft", "Sultan Salahuddin Abdul Aziz Shah Polytechnic", "Salem University", "Marian College", 
"The School of the Art Institute of Chicago", "Missouri Southern State College", "International Medical & Technological University", "Coastal Carolina University", "Universidad Católica de Ávila", 
...
//console.log(uni);
const result = universities.filter(word => word.includes('Uni'));
...
*/
const animalNames = [{Name: "Jackal", Location: "asiatic", population: 7000, Scientific: "Canis aureus."}, {Name: "Lion", Location: "african", population: 2, Scientific: "Canis"}, 
{Name: "Tiger", Location: "asiatic", population: 800, Scientific: "Canis india"}];
...
let lowerCase = animalNames.map(animal => animal.Name.toLowerCase());
...
let lowerPopulation = animalNames.filter((animal) => {
...
let populationTotal = animalNames.reduce((acc, val) => {
