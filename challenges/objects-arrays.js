...
//const uni = graduates.filter(graduate => graduate.university.includes("Uni") ).map(graduate => graduate.university);
const uni = [];
for(x = 0; x < graduates.length; x++){
...
//should't this be called smallerPopulations??

/* Request 4: .reduce() 
The zoos need to know their total animal population across the United States.  Find the total population from all the zoos using the .reduce() method.
*/

const reducer = function(accumulator, animal){
