...
const uni = [];
for (let i = 0; i < graduates.length; i++) if (graduates[i].university.search("Uni") != -1) uni.push(graduates[i].university);
console.log(uni);
...
let populationTotal = zooAnimals.reduce((a, c) => a + c.population, 0);
