...
console.log(dinossaurOne.weight);

// What was the diet of a velociraptor?
console.log(dinossaurThree.diet);

// How long was a stegosaurus?
console.log(dinossaurTwo.length);

// What time period did tyrannosaurus live in?
console.log(dinossaurOne.period);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(dinossaurOne.roar());
...
sortUniversities = universities.sort();
console.log(sortUniversities)
