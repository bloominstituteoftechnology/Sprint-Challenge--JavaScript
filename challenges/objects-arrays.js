...
*/
let arr = [];
let displayNames = zooAnimals.forEach((item) => {
  return arr.push(`Name: ${item.animal_name}, Scientific: ${item.scientific_name}`)
})
displayNames = arr;
...
*/
const populationArray = zooAnimals.map((item) => {
  return item.population;
})
const populationTotal = populationArray.reduce((value, accumilator) => {
