...
for (i = 0; i < graduates.length - 1; i++) {
  univArray.push(graduates[i].university);
}
universities = univArray.sort();
universities.splice(universities.length -1, 1);
