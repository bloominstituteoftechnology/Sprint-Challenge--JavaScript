...
class CubeMaker extends CuboidMaker {
    ...
    cubeSurface = () =>  2 * ((this.length * this.width) + (this.length * this.height) + (this.width * this.height));

}

const newCube = new CubeMaker(10,10,10);

// Test
console.log(newCube.cubeVolume()); // 1000
console.log(newCube.cubeSurface()); // 600
