...
class CuboidMaker1 {
    constructor (cuboidMakerAttributes1){
        this.length=cuboidMakerAttributes1.length;
        this.width=cuboidMakerAttributes1.width;
        this.height=cuboidMakerAttributes1.height;
    }
    volume(){
